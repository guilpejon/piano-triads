<script lang="ts">
  ...
  function getStaffPosition(noteName: string): { treble: number, bass: number, octave: number, note: string, accidental: string } {
    ...
    if (octave === 4) {
      switch (note) {
        case 'C': treblePosition = -1; break; // Below staff
        case 'D': treblePosition = 0; break;  // Below staff 
        case 'E': treblePosition = 1; break;  // Bottom line
        case 'F': treblePosition = 2; break;  // First space
        case 'G': treblePosition = 3; break;  // Second line
        case 'A': treblePosition = 4; break;  // Second space
        case 'B': treblePosition = 5; break;  // Third line
      }
    } else if (octave === 5) {
      switch (note) {
        case 'C': treblePosition = 6; break;  // Third space
        case 'D': treblePosition = 7; break;  // Fourth line
        case 'E': treblePosition = 8; break;  // Fourth space
        case 'F': treblePosition = 9; break;  // Top line
        case 'G': treblePosition = 10; break; // Above staff
        case 'A': treblePosition = 11; break; // Above staff
        case 'B': treblePosition = 12; break; // Above staff
      }
    } else if (octave === 3) {
      switch (note) {
        case 'C': treblePosition = -8; break;
        case 'D': treblePosition = -7; break;
        case 'E': treblePosition = -6; break;
        case 'F': treblePosition = -5; break;
        case 'G': treblePosition = -4; break;
        case 'A': treblePosition = -3; break;
        case 'B': treblePosition = -2; break;
      }
    } else {
    ...
    if (octave === 2) {
      switch (note) {
        case 'G': bassPosition = 0; break;
        case 'A': bassPosition = 1; break;
        case 'B': bassPosition = 2; break;
      }
    } else if (octave === 3) {
      switch (note) {
        case 'C': bassPosition = 3; break;
        case 'D': bassPosition = 4; break;
        case 'E': bassPosition = 5; break;
        case 'F': bassPosition = 6; break;
        case 'G': bassPosition = 7; break;
        case 'A': bassPosition = 8; break;
        case 'B': bassPosition = 9; break;
      }
    } else if (octave === 4) {
      switch (note) {
        case 'C': bassPosition = 10; break;
        case 'D': bassPosition = 11; break;
        case 'E': bassPosition = 12; break;
        case 'F': bassPosition = 13; break;
      }
    } else {
      // General calculation for other octaves
      const basePosition = notePositions[note];
  ...
  $: processedNotes = activeNotes.map(noteName => {
