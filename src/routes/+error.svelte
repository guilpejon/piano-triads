...
<svelte:head>
  ...
  <meta
    name="description"
    content="Oops! The page you're looking for doesn't exist. Let's get you back on track with Piano Triads."
  />
</svelte:head>
    ...
    <div class="error-content">
      ...
      <div class="piano-container">
        <div class="piano-keys">
          {#each Array(12) as _, i}
            <div
              class="piano-key {i === 1 || i === 3 || i === 6 || i === 8 || i === 10
                ? 'black'
                : 'white'}"
      ...
      <div class="error-message">
        ...
        <p class="error-description">
          {#if is404}
            The page you're looking for seems to have wandered off like a lost melody. Let's get you
            back to the main composition!
          {:else}
            We hit a wrong note! Don't worry, even the best musicians make mistakes. Let's try a
            different tune.
          {/if}
        </p>
      </div>
